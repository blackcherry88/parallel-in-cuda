//This is copied from ECE408 mp0 task
...
int main(int argc, char ** argv) {
    ...
    for (int dev = 0; dev < deviceCount; dev++) {
		...
		wbLog(TRACE, " Maximum threads per SM: ", deviceProp.maxThreadsPerMultiProcessor);
		wbLog(TRACE, " Maximum blocks per SM: ", deviceProp.maxBlocksPerMultiProcessor);
